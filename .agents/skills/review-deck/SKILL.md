...
Read and follow `../../../skills/review-deck/SKILL.md` as the authoritative workflow. Resolve bundled references and scripts relative to that authoritative skill directory.
