...
Usage:
  claude-slides init <title> [--format html|marp|pptx] [--dir path] [--force]
  claude-slides check <path> [--json]
  claude-slides doctor [--json]
  claude-slides version
  claude-slides help

Examples:
  claude-slides init "AI Agent Platform" --format html
  claude-slides init "Quarterly Review" --format pptx --dir presentations/q3
  claude-slides check slides/ai-agent-platform
`;
}
