...
import { runPromoPipeline } from '../scripts/promo-pipeline.mjs';
...
Usage:
  ...
  codex-slides promo run <repository-path> [--out path] [--source-url url] [--deck path] [--html path] [--speaker-notes path] [--narration path] [--tts-command command] [--frames path] [--capture] [--video path] [--package path] [--visual-evidence path] [--visual-inspected] [--require-visual] [--render] [--strict] [--json]
...
export async function main(argv = process.argv.slice(2), io = process) {
  ...
  if (command === 'promo') {
    if (options.help || positionals[0] === 'help') {
      write(
        io.stdout,
        'Usage: codex-slides promo run <repository-path> [--out path] [--source-url url] [--deck path] [--html path] [--speaker-notes path] [--narration path] [--tts-command command] [--frames path] [--capture] [--video path] [--package path] [--visual-evidence path] [--visual-inspected] [--require-visual] [--render] [--strict] [--json]',
      );
      return 0;
    }
    if (positionals[0] !== 'run') {
      throw new CliError('Use `promo run <repository-path>` or `promo help`.');
    }
    const result = await runPromoPipeline({
      source: positionals[1] || options.source,
      output: options.out,
